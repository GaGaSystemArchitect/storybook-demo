...
interface MonthCalendarProps extends CalendarProps {
    selectHandlers?: (date: Dayjs) => void
    curMonth: Dayjs
}
...
function renderDays(
    ...
    value: Dayjs,
    selectHandler: MonthCalendarProps['selectHandlers']
) {
    const rows = [];
    for (let i = 0; i < 6; i++) {
        const row = [];
            ...
            >
                {
                    dateRender ? dateRender(item.date) : (
                        <div className="calendar-month-body-cell-date">
                            <div className={cs("calendar-month-cell-body-date-value",
...
function MonthCalendar(props: MonthCalendarProps) {
    ...
    return <div className="calendar-month">
        ...
        <div className="calendar-month-body">
            {
                renderDays(allDays, dateRender, dateInnerContent, value, selectHandlers)
            }
        </div>
    </div>
}
